...
app = Flask(__name__)
app.config['UPLOAD_FOLDER'] = 'C:\Users\shrey\OneDrive\Desktop\minifinal\app.py'

def get_opened_image(image):
    return Image.open(image).convert('RGB')

def _loadmodel():
    return load_model(r'C:\Users\shrey\OneDrive\Desktop\minifinal\model.h5',compile=False)
